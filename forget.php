...
<div class="form" style="height:400px;">
	...
	<form action="" method="post">
		...
		<div style="display: flex;">
			<input type="text" name="number" placeholder="Kode" style="width: 60%;margin-left: 10px;">
			<a href="#" style="text-decoration:none;"><div class="tombol-besar" style="width: 150px;border-radius:5px;margin: 19px 10px 0 -15px;z-index: 2;">Minta Kode</div></a>
		</div>
